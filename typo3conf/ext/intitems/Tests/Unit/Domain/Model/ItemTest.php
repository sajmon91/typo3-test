...
{
    /**
     * @var \Int\Intitems\Domain\Model\Item
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = new \Int\Intitems\Domain\Model\Item();
    }
     ...
     * @test
     */
    public function getFiles1ReturnsInitialValueForFileReference()
    {
        self::assertEquals(
            null,
            $this->subject->getFiles1()
        );
    }
     ...
     * @test
     */
    public function setFiles1ForFileReferenceSetsFiles1()
    {
        $fileReferenceFixture = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $this->subject->setFiles1($fileReferenceFixture);
     ...
     * @test
     */
    public function getPropertiesReturnsInitialValueForItemProperty()
    {
     ...
     * @test
     */
    public function setPropertiesForObjectStorageContainingItemPropertySetsProperties()
    {
        $property = new \Int\Intitems\Domain\Model\ItemProperty();
