...
return [
    ...
    'columns'  => [
        ...
        'header2'           => \Int\Intbuilder\Utility\TcaUtility::addInput(
            'download.header2',
            'tt_content',
            [
                'eval' => 'trim',
        ...
        'subheader1'        => \Int\Intbuilder\Utility\TcaUtility::addInput(
            'download.subheader1',
            'tt_content',
            [
                'eval' => 'trim',
        ...
        'subheader2'        => \Int\Intbuilder\Utility\TcaUtility::addInput(
            'download.subheader2',
            'tt_content',
            [
                'eval' => 'trim',
        ...
        'files'             => \Int\Intbuilder\Utility\TcaUtility::addImage(
            'download.file',
            'tt_content',
            0,
            1,
