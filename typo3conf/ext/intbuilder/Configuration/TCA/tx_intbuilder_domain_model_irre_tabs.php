...
return [
    ...
    'columns'  => [
        ...
        'content_type'      => \Int\Intbuilder\Utility\TcaUtility::addSelect(
            'content_type',
            $table,
            [
                [ '', 0 ],
        ...
        'images'            => \Int\Intbuilder\Utility\TcaUtility::addImage(
            ...
            'png,jpg,jpeg,gif',
            [
                'displayCond' => 'FIELD:content_type:IN:11,12,20,21,22,23',
            ]
        ),
        'text'              => \Int\Intbuilder\Utility\TcaUtility::addRte(
            ...
            'tt_content',
            [
                'displayCond' => 'FIELD:content_type:IN:10,11,12,20,21,22,23',
            ]
        ),
        'text2'             => \Int\Intbuilder\Utility\TcaUtility::addRte(
            'text2',
            'tt_content',
            [
                'displayCond' => 'FIELD:content_type:IN:10,20,21,22,23',
            ]
        ),
    ],
];