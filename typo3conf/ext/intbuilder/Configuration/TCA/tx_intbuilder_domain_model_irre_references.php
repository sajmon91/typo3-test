...
return [
    ...
    'columns'  => [
        ...
        'tags'              => [
            'exclude' => true,
            'label'   => $langFile . 'tx_intbuilder_domain_model_irre_references.field.tags',
            'config'  => [
                'type'                => 'select',
                'renderType'          => 'selectMultipleSideBySide',
                'foreign_table'       => 'tx_intbuilder_domain_model_category',
                'foreign_table_where' => ' AND tx_intbuilder_domain_model_category.sys_language_uid IN (-1,0) AND tx_intbuilder_domain_model_category.type IN (' . \Int\Inthelper\Domain\Model\Enum\CategoryType::REFERENCE_CATEGORY . ', ' . \Int\Inthelper\Domain\Model\Enum\CategoryType::LOCATION_CATEGORY . ')',
                'MM'                  => 'tx_intbuilder_references_category_mm',
                'size'                => 10,
                'autoSizeMax'         => 30,
                'maxitems'            => 9999,
                'multiple'            => 0,
