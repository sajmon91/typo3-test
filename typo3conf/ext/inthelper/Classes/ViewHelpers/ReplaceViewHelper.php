...
class ReplaceViewHelper extends AbstractViewHelper
{
    ...
    {
        $this->registerArgument('searchString', 'string', ' Search String', true);
        $this->registerArgument('replaceString', 'string', ' Replace String', true);
    }
    ...
    public static function renderStatic(
        ...
        $replaceString = $arguments['replaceString'];
